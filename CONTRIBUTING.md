...
We are pretty open about giving commit rights to the documentation tree.
...
so to add a few other checkouts, you could say:
    ...
    $ mkdir -p 2020-12-05       # the software as of a particular date
      ...etc...
    $ cd release
    $ fossil open ~/docsrc/lumosql.fossil release
    $ cd ../v201951215
    $ fossil open ~/docsrc/lumosql.fossil v20191215
    $ cd ../2020-12-05
    $ fossil open ~/docsrc/lumosql.fossil 2020-12-05
      ...etc...
...
The LumoSQL documentation project uses tags for [each released version][tags], and it
